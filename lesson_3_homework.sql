...
--task2
-- орабли: ƒл€ каждого класса определите год, когда был спущен на воду первый корабль этого класса. 
--≈сли год спуска на воду головного корабл€ неизвестен, определите минимальный год спуска на воду кораблей этого класса. ¬ывести: класс, год.
...
-- т.к. число орудий и водоизмещение наход€тс€ в таблице classes, нам нужны только те корабли, по которым можно определить класс
...
displ_numguns as 				-- определ€ем максимальное число орудий в каждой группе по весу водоизмещени€
	(select displacement,
...
--task5
-- омпьютерна€ фирма: Ќайдите производителей принтеров, которые производ€т ѕ  с наименьшим объемом RAM и с самым быстрым процессором среди всех ѕ , имеющих наименьший объем RAM. ¬ывести: Maker
